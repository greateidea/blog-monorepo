...
export const sideBarData = [
  ...
  },
  {
    ...
    ogUrl: import.meta.env.DEV
      ? "http://localhost:5173/podman-start"
      : "https://blog.hiou.top/podman-start",
  ...
  },
  {
    ...
    ogUrl: import.meta.env.DEV
      ? "http://localhost:5173/podman-persistence"
      : "https://blog.hiou.top/podman-persistence",
    ...
    headerDes: [
      ...
      "&amp; A kitten named Little/Old Bread.",
      "November 4, 2025",
    ],
  },
  {
  ...
  },
  {
    ...
    ogUrl: import.meta.env.DEV
      ? "http://localhost:5173/dollar-state"
  ...
  },
  {
    ...
    ogUrl: import.meta.env.DEV
      ? "http://localhost:5173/dollar-effect"
      : "https://blog.hiou.top/dollar-effect",
    href: "hiou.top/dollar-effect/index.html",
    containerStyle: { maskImage: "linear-gradient(to bottom, black 99.1%, transparent 100%)" },
    headerDes: [
      "The setting sun shines golden light.",
      "&amp; The kitten is snoring.",
      "November 19, 2025",
    ],
  },
  {
  ...
  },
  {
    ...
    ogUrl: import.meta.env.DEV
      ? "http://localhost:5173/svelte-checkversion"
      : "https://blog.hiou.top/svelte-checkversion",
    href: "hiou.top/svelte-checkversion/index.html",
    containerStyle: { maskImage: "linear-gradient(to bottom, black 98.8%, transparent 100%)" },
    headerDes: [
      "The winter in the south is not so cold.",
      "&amp; Learning makes me feel warm.",
      "November 25, 2025",
    ],
  },
  {
    ...
    ogUrl: import.meta.env.DEV
      ? "http://localhost:5173/svelte-base-render"
      : "https://blog.hiou.top/svelte-base-render",
  ...
  },
  {
    ...
    ogUrl: import.meta.env.DEV
      ? "http://localhost:5173/svelte-code-effect"
      : "https://blog.hiou.top/svelte-code-effect",
  ...
  },
  {
    ...
    ogUrl: import.meta.env.DEV
      ? "http://localhost:5173/svelte-code-array"
      : "https://blog.hiou.top/svelte-code-array",
...
const Article: React.FC<{ htmlString?: string }> = ({ htmlString }) => {
  ...
  const {
    ...
    containerStyle,
    headerDes,
  } = sideBarData.find((v) => v.code === code) || {};
  ...
  return (
    <div style={{ isolation: "isolate" }}>
      <div
        ...
        style={
          containerStyle || {
            maskImage: "linear-gradient(to bottom, black 98.9%, transparent 100%)",
          }
        }
      >
